<?php
require "../Controllers/suppressionController.php";
?>
<!DOCTYPE html>
<html lang="fr">
...
<div class=" d-none d-xl-block d-lg-block d-md-block">
    ...
    <div class="d-flex justify-content-center align-items-center m-5">
        <div class="m-5">
            <p class="white text-center">Êtes-vous sûr de vouloir supprimer votre compte ? </br> L'effet sera définitif.</p>
        </div>
        <div class="m-5">
            <form action="suppression.php" method="post">
                <button class="btn btn-danger" style="width:100px" type="submit" name="deleteButton">Oui</button>
            </form>
            <a href="profile.php">
                <button class="btn btn-primary" style="width:100px" type="button">Non</button>
            </a>
        </div>
    </div>
