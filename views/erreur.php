...
<h1 class="text-center">Oups ! il s'emblerait que les forces du mal vous ont dirigé vers une zone inconnu !</h1>
    <div class="d-flex justify-content-center align-items-center mt-5"><img class="img1 col-6" src="../assets/img/dsl.gif.crdownload" alt="groupe d'aventuriers"></div>
