...
<body>
    ...
    <div class="mt-5  text-left m-auto col-10 backgroundBlue mt-5">
        <pre>
            <article>
                <h3 class="text-center white">Les types de dégâts</h3>

 
<p class="white">Classique : attaque de base sans effet
...
<h3 class="text-center white">les statistiques</h3>

<p class="white">il y a 5 statistiques que l'on peut augmenter :
...
<h3 class="text-center white">Le coût de dépense de l'expérience (ou px)</h3>

<p class="white">+ 1 PM  20 PX
+ 1 PV   10 PX
...
<h3 class="text-center white">Armures</h3>

<p class="white">Les CA sont des réductions de dégâts, ainsi une personne ayant 2 en CA vera ses dégats subits diminué de 2.
...
Lourde  +2CA malus de 1 en DEX</p></article>
        ...
        <pre><article>
            <h3 class="text-center white">Système de race</h3>

<p class="white">Le choix d’une race est un élément important dans la création de personnage
