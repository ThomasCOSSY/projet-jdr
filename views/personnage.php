...
<div class=" d-none d-xl-block d-lg-block d-md-block">
    ...
    <form action="personnage.php" method="post">
        ...
        <div class="m-1 d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-success" type="submit" name="updatePlayer" value="<?= $playerInformation['player_id'] ?> ">sauvegarder</button> </div>
    </form>
